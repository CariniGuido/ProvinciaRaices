<main class="contenedor">
    ...
    <form class="formulario" action="/contacto" method="POST">
        ...
        <fieldset>
            ...
            <label for="mensaje">Mensaje</label> <!-- Mantén el mismo id en el atributo for -->
            <textarea name="contacto[mensaje]" id="mensaje" cols="30" rows="10" required></textarea> <!-- Mantén el mismo id en el elemento textarea -->
        ...
        <fieldset>
            ...
            <label for="precio">Precio o presupuesto</label> <!-- Cambié el id a "precio" -->
            <input type="number" placeholder="Tu precio o presupuesto" id="precio" name="contacto[precio]" required> <!-- Mantén el mismo id en el input -->
